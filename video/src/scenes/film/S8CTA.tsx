    ...
    <FilmShell scene="cta" audio={audio}>
      <AbsoluteFill style={{ alignItems: "center", justifyContent: "center" }}>
        <div style={{ textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", gap: 16 }}>
          ...
          <h1 style={{ margin: "4px 0 0", fontFamily: font.sans, fontSize: 60, fontWeight: 700, letterSpacing: -1.6, lineHeight: 1.1, color: color.text, ...reveal(frame, sec(0.8), 22) }}>
            Evaluate AI with evidence,
            <br />
            <span style={{ color: color.accentBright }}>not vibes.</span>
          </h1>
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap", justifyContent: "center", maxWidth: 760, marginTop: 18, ...reveal(frame, sec(1.6), 16) }}>
            {cta.chips.map((c) => (
          ...
          <span style={{ fontFamily: font.sans, fontSize: 20, color: color.textMuted, marginTop: 18, ...reveal(frame, sec(2.2), 14) }}>{cta.author}</span>
        </div>
      </AbsoluteFill>
    </FilmShell>
  );
