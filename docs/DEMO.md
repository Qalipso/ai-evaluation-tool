...
> Note (public demo): some seeded runs (e.g. the Shadow runs) currently show header totals but no per-case rows. Use the **RAG — Internal Docs QA** run above for a fully populated walkthrough.
